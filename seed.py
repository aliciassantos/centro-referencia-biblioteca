...
def populate_database():
    ...
    try:
        ...
        topics = [
            ...
            Topico(
                id=3, nome="Manutenção Interna", publico=False
        ...
        associations = [
            InstrucaoTopico(
                instrucao_id=1, topico_id=2
            ),  # 'Renovação' vinculada a 'Cadastro'
            InstrucaoTopico(
                instrucao_id=2, topico_id=3
            ),  # 'Inventário' vinculado a 'Manutenção Interna'
        ]

from sqlalchemy import Column, Integer, String, Boolean, ForeignKey, DateTime, create_engine, select, Text
...
class NivelAcesso(Base):
    ...
    usuarios: Mapped[list["Usuario"]] = relationship(
        back_populates="nivel_acesso"
    )
    instrucoes: Mapped[list["Instrucao"]] = relationship(
        back_populates="nivel_acesso"
    )
'''
...
class Instrucao(Base):
    ...
    usuario_atualizou_id: Mapped[int | None] = mapped_column(
